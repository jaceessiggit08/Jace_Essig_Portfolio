...
## MLB Pitch Velocity Prediction Model

Developed a machine-learning regression model using MLB pitching data to analyze and predict pitch velocity.

The project included data cleaning, feature engineering, regression analysis, and model evaluation using Python, Pandas, and Scikit-learn.
